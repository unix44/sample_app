...
describe UsersController do
    ...
    describe "GET 'edit'" do
        ...
        it "should have a link to change Gravatar" do
            get :edit, :id => @user
            gravatr_url = 'http://gravatar.com/emails'
            response.should have_selector( 'a', :href => gravatr_url, 
                                                :content => "change" )
        end
    ...
    describe "authentication of edit/update pages" do
        ...
        describe "for signed-in users" do
            ...
            it "should reuire matching users for 'edit'" do
                get :edit, :id => @user
    ...
    describe "check delete microposts" do
        ...
        it "should not have delete link" do
            wrong_user = Factory( :user, :email => "user@example.ru" )
            test_sign_in( wrong_user )
            get :show, :id => @user
            response.should have_selector( 'a', :href    => "/users/#{@user.id}", 
                                                :content => "/users/#{@user.id}" )
    ...
    describe "GET 'index'" do
        ...
        describe "for signed-in users" do
            ...
            before( :each ) do
                ...
                second = Factory( :user, :name => "Bob", :email => "second@email.com" )
                third = Factory( :user, :name => "Ben", :email => "third@mail.com" )
